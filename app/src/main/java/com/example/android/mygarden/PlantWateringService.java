...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        long creationTime = cursor.getLong(cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_CREATION_TIME));
        long lastWateredTime = cursor.getLong(cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME));
        int plantType = cursor.getInt(cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_PLANT_TYPE));

        long currentTime = System.currentTimeMillis();

        int imgResource = PlantUtils.getPlantImageRes(this,
                currentTime - creationTime,
                currentTime - lastWateredTime,
                plantType);
